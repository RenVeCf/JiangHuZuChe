...
public class OrderDetailsPresenter extends OrderDetailsContract.Presenter {
    ...
    @Override
    public void getCarReturnDetails(TreeMap<String, String> map, boolean isDialog, boolean cancelable) {
        model.getCarReturnDetails(context, map, isDialog, cancelable, getView().bindLifecycle(), new ObserverResponseListener() {
            @Override
            public void onNext(Object o) {
                //这一步是必须的，判断view是否已经被销毁
                if (getView() != null) {
                    getView().resultCarReturnDetails((CarReturnDetailsBean) o);
                }
            }
    ...
    @Override
    public void getCarReturnCancelOrder(TreeMap<String, String> map, boolean isDialog, boolean cancelable) {
        model.getCarReturnCancelOrder(context, map, isDialog, cancelable, getView().bindLifecycle(), new ObserverResponseListener() {
            @Override
            public void onNext(Object o) {
                //这一步是必须的，判断view是否已经被销毁
                if (getView() != null) {
                    getView().resultCarReturnCancelOrder((CancelOrderBean) o);
                }
            }
    ...
    @Override
    public void getCarReturnConfirm(TreeMap<String, String> map, boolean isDialog, boolean cancelable) {
        model.getCarReturnConfirm(context, map, isDialog, cancelable, getView().bindLifecycle(), new ObserverResponseListener() {
            @Override
            public void onNext(Object o) {
                //这一步是必须的，判断view是否已经被销毁
                if (getView() != null) {
                    getView().resultCarReturnConfirm((CarReturnConfirmBean) o);
                }
            }
